...
def main():
 ...
 for name,f in [('det4',ch.det4_terms()),('z_per3',ch.padded_per3_terms())]:
  x=run(name,f,2);print(x,flush=True);rec.append(x)
 out={'schema':'reverse_hessian.fitting_s2_exact.v1','records':rec};a.out.write_text(json.dumps(out,indent=2,sort_keys=True)+'\n')
