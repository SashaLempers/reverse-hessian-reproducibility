...
\date{Release corrective v2.1.0 --- 19 juillet 2026}
\begin{document}
\maketitle
...
\small
\input{claim_matrix.tex}
\normalsize

\section{Provenance et citation}
La source canonique est le tag \texttt{v2.1.0-corrective}. Le manifeste actif se trouve dans \texttt{07\_MANIFEST}. Les archives forensiques, l'audit initial et les anciens registres mixtes sont des assets de release avec SHA-256. Citer le manuscrit concerné, le module exact, le tag et, lorsqu'il existe, le DOI d'archive.
